-- CreateEnum
CREATE TYPE "public"."TRIGGER" AS ENUM ('Webhook', 'Github');
...
-- CreateTable
CREATE TABLE "public"."AvailableTrigers" (
    "id" TEXT NOT NULL,
    "zapId" TEXT NOT NULL,

    CONSTRAINT "AvailableTrigers_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "public"."Trigger" ADD CONSTRAINT "Trigger_triggerId_fkey" FOREIGN KEY ("triggerId") REFERENCES "public"."AvailableTrigers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
